<div class="header_top_bar">
	...
	<ul class="social_icons clearfix">
		<li>
			<a href="/news/vi/"> <img src="<?=BASE_DIR?>co/vi.png" style="margin:10px"> </a>
			<a href="/news/en/"> <img src="<?=BASE_DIR?>co/en.png" style="margin:10px;"> </a>
		</li>
		<li>
		...
		<li>
			<a href="http://themeforest.net/" class="social_icon envato" title="envato">
				&nbsp;
			</a>
		</li>
	</ul>
