                        ...
                        <div class="header">
                            ...
                            <form method="get" action="" class="bg-info p-t-10 p-b-10 p-l-10">
                                ...
                                <?php $listTL= $qt->ListTheLoai();?>
                                    <select id="idTL" name="idTL" class="btn btn-success"> ///onchange="this.form.idLT.value=-1; this.form.lang.value=''; this.form.submit();"> 
                                ...
                                <?php $listLT= $qt->LoaiTinTrongTheLoaiA($idTL);?>    
                                    <select id="idLT" name="idLT" class="btn btn-primary"> ///onchange="this.form.idTL.value= -1; this.form.lang.value=''''; this.form.submit();">  
                                    ...
                                    <select name="lang" class="btn btn-warning" onchange="this.form.idTL.value=-1; this.form.idLT.value=-1; this.form.submit();"> 
...
$(document).ready(function(){
    $("#idTL").change(function(){
        var idTL = $(this).val()  //$("#idTL").val()
        $("#idLT").load("lttrongtl.php?idTL="+idTL, function(){document.location='index.php?p=tin_ds&idTL='+idTL});
    })
})
</script>
