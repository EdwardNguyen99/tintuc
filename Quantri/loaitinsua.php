                ...
                <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-9">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="ThuTu" name="ThuTu" class="form-control" placeholder="Nhập thứ tự" value="<?=$row['ThuTu']?>" required min="1" max="1000">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                            <div class="form-group">
                                <div class="form-line abc">
                                    <input type="radio" id="AH1" value="<?=($row['ThuTu']==1)?"Checked":""?>" name="AnHien" checked value="1">
                                    <label for="AH1">Hiện</label>
                                    <input type="radio" id="AH0" value="<?=($row['ThuTu']==0)?"Checked":""?>" name="AnHien" value="0">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-9">
                            <div class="form-group">
                                <div class="form-line abc">
                                    <input type="radio" id="vi" name="lang" value="<?=($row['ThuTu']=='vi')?"Checked":""?>" checked value="vi">
                                    <label for="vi">Tiếng Việt</label>
                                    <input type="radio" id="en" name="lang" value="<?=($row['ThuTu']=='en')?"Checked":""?>" value="en">
