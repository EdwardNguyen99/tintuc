...
<div class="caroufredsel_wrapper caroufredsel_wrapper_small_slider">
	<ul class="small_slider id-small_slider">
		...
		<li class="slide">
			...
			<a href="<?=BASE_DIR?>bv/<?=$row['TieuDe_KhongDau'];?>.html" title="Nuclear Fusion Closer to Becoming a Reality">
		    ...
		    <div class="slider_content_box">
				...
				<h2><a href="<?=BASE_DIR?>bv/<?=$row['TieuDe_KhongDau'];?>.html" title="<?=$row['TieuDe']?>"><?=$row['TieuDe']?></a></h2>
